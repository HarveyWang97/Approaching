...
describe('(connected) Popup -- Add Item', () => {
    ...
    it('should have correct payload as in the store', () => {
        expect(wrapper.prop('payload')).toEqual(addItemPopupStore.popup.payload);
    });

    it('should have correct initial state', () => {
        expect(component.state('editing')).toBe(true);
        expect(component.state('payload')).toEqual({
            location: addItemPopupStore.popup.payload.currentLocation
        });
    });
