...
public class DeleteItemTest {
  ...
  public void testDeleteItem() throws Exception {
    ...
    driver.findElement(By.cssSelector("svg.svg-inline--fa.fa-trash-alt.fa-w-14.fa-lg > path")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='>'])[2]/following::span[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Facebook onsite'])[1]/following::div[4]")).click();
